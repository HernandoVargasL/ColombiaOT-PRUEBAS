...
var tableRecursos;
const tipoRecurso = "Datos para el OT";
    ...
    for (var i = 0; i < dataRow.length; i++) {
        ...
        if (nbotones > 0) {
            ...
            if (dataRow[i].URL1 != null) {
                ...
                strHTML = strHTML + "<button class='btn btn-default' style='width: 100%;margin-right: 10px;' onclick='window.open(\"" + dataRow[i].URL1 + "&u=0" + "\", \"_blank\"); return false;'>Ver m&aacute;s</button>";
                strHTML = strHTML + "</td>";
            }
            if (dataRow[i].URL2 != null) {
                strHTML = strHTML + "<td style='width: " + botonesSize + ";'>";
